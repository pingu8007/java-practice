...
public class QueryDemo3 {
	public static void main(String[] args) {
		...
		try {
			...
			// String qryStmt = "select convert(varchar(10),hiredate,111) as
			...
			while (rs.next()) {
				...
				// String ename = rs.getString("ename");
				// String hiredate = rs.getString("hiredate"); // 2004-12-25
				// 00:00:00.0 //v1
				// String salary = rs.getString("salary"); // 56000.00
				//
				// Object empno = rs.getObject("empno");
				// Object ename = rs.getObject("ename");
				// String hiredate = rs.getString("hiredate").replace("-",
				// "/").substring(0, 10); // v2
				String hiredate = "";
				try {
					hiredate = String.format("%1$tY/%1$tm/%1$td",
							new SimpleDateFormat("YYYY-MM-dd").parse(rs.getString("hiredate")));
				} catch (ParseException e) {
					e.printStackTrace();
				} // v3
					// Object hiredate = rs.getObject("hiredate"); // 2004-12-25
					// 00:00:00.0
					...
					// java.sql.Date hiredate = rs.getDate(3); // 2004-12-25,
